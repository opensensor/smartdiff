...
pub static LANGUAGE_CONFIGS: Lazy<HashMap<Language, LanguageConfig>> = Lazy::new(|| {
    ...
    configs.insert(
        ...
        LanguageConfig {
            ...
            function_node_types: vec!["method_declaration", "constructor_declaration"],
            class_node_types: vec![
                "class_declaration",
                "interface_declaration",
                "enum_declaration",
            ],
            comment_node_types: vec!["line_comment", "block_comment"],
    ...
    configs.insert(
        ...
        LanguageConfig {
            ...
            function_node_types: vec!["function_definition"],
            class_node_types: vec!["class_definition"],
    ...
    configs.insert(
        ...
        LanguageConfig {
            ...
            class_node_types: vec!["class_declaration"],
            comment_node_types: vec!["comment"],
    ...
    configs.insert(
        ...
        LanguageConfig {
            ...
            class_node_types: vec!["class_specifier", "struct_specifier", "union_specifier"],
            comment_node_types: vec!["comment"],
    ...
    configs.insert(
        ...
        LanguageConfig {
            ...
            function_node_types: vec!["function_definition", "function_declarator"],
            class_node_types: vec!["struct_specifier", "union_specifier"],
            comment_node_types: vec!["comment"],
            identifier_field_names: vec!["declarator", "name"],
        },
    );
