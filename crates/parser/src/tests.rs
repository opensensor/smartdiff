...
mod unit_tests {
    ...
    fn test_language_detection_from_path() {
        ...
        assert_eq!(
            LanguageDetector::detect_from_path("test.java"),
            Language::Java
        );
        assert_eq!(
            LanguageDetector::detect_from_path("test.py"),
            Language::Python
        );
        assert_eq!(
            LanguageDetector::detect_from_path("test.pyw"),
            Language::Python
        );
        assert_eq!(
            LanguageDetector::detect_from_path("test.js"),
            Language::JavaScript
        );
        assert_eq!(
            LanguageDetector::detect_from_path("test.jsx"),
            Language::JavaScript
        );
        assert_eq!(
            LanguageDetector::detect_from_path("test.cpp"),
            Language::Cpp
        );
        assert_eq!(LanguageDetector::detect_from_path("test.cc"), Language::Cpp);
        assert_eq!(
            LanguageDetector::detect_from_path("test.cxx"),
            Language::Cpp
        );
        assert_eq!(
            LanguageDetector::detect_from_path("test.hpp"),
            Language::Cpp
        );
        ...
        assert_eq!(
            LanguageDetector::detect_from_path("test.unknown"),
            Language::Unknown
        );
    }
...
"#;
        assert_eq!(
            LanguageDetector::detect_from_content(java_code),
            Language::Java
        );
...
"#;
        assert_eq!(
            LanguageDetector::detect_from_content(js_code),
            Language::JavaScript
        );
...
"#;
        assert_eq!(
            LanguageDetector::detect_from_content(cpp_code),
            Language::Cpp
        );
...
"#;
        ...
        assert_eq!(
            LanguageDetector::detect("test.cpp", ambiguous_code),
            Language::Cpp
        );

        // Should detect as C based on file extension
        assert_eq!(
            LanguageDetector::detect("test.c", ambiguous_code),
            Language::C
        );
...
"#;
        ...
        assert_eq!(
            LanguageDetector::detect("test.txt", clear_python),
            Language::Python
        );
    }
    ...
    fn test_tree_sitter_parser_creation() {
        ...
        assert!(
            parser.is_ok(),
            "TreeSitterParser should be created successfully"
        );
...
"#;
        ...
        assert!(
            ...
            "Should find struct nodes mapped to class"
        );
    }
...
"#;
        ...
        assert!(
            ...
            "Should find at least 3 functions (constructor + 2 methods)"
        );
        assert!(analysis.class_count >= 1, "Should find at least 1 class");
        assert!(
            analysis.cyclomatic_complexity > 0,
            "Should have some cyclomatic complexity"
        );
...
"#;
        ...
        assert!(
            signatures.len() >= 3,
            "Should extract at least 3 function signatures"
        );
...
"#;
        ...
        let result = parser
            .parse(python_code, Language::Python)
            .expect("Parsing should succeed");
        ...
        let class_symbols: Vec<_> = all_symbols
            .iter()
...
"#;
        ...
        let result = parser
            .parse(js_code, Language::JavaScript)
            .expect("Parsing should succeed");
